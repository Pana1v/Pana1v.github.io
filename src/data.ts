...
export const DATA: DataStructure = {
  ...
  skills: [
    "ROS 2", "ROS Noetic", "SLAM", "Computer Vision", "PyTorch", "GNN", "Nav2", "C++", "Python", "TypeScript", "Node.js", "WebSockets", "Three.js", "Gazebo", "Kalman Filter", "YOLO"
  ],
  openSource: [
    {
      title: "Nav2",
  ...
  projects: [
    {
      ...
      image: "https://picsum.photos/seed/polka/800/600",
    ...
    },
    {
      ...
      tags: ["Graph Neural Networks", "PyTorch", "Robotics"],
    ...
    },
    {
      ...
      tags: ["ROS Noetic", "Gazebo", "Kalman Filter", "LiDAR"],
    ...
    },
    {
      ...
      tags: ["Node.js", "WebSockets", "Three.js", "ROS 2"],
    ...
    },
    {
      ...
      tags: ["Computer Vision", "LLM", "YOLO", "PyTorch"],
