...
export const DATA: DataStructure = {
  ...
  "experienceSummary": "Building autonomous robots across agriculture, construction, and industrial domains — from SLAM and perception to full-stack motion planning.",
  "experience": [
    {
      "company": "Eternal.ag",
